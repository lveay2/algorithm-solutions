...
public class _1469_Longest_Path_On_The_Tree {
    ...
    public static int longestPath(int n, int[] starts, int[] ends, int[] lens) {
        if (starts == null || starts.length == 0 || ends == null || ends.length == 0 || lens == null || lens.length == 0) {
            return 0;
        }
    ...
    private static Map<Integer, Map<Integer, Integer>> buildGraph(int[] starts, int[] ends, int[] lens) {
    ...
    public static void main(String[] args) {
        System.out.println(longestPath(5, new int[]{0, 0, 2, 2}, new int[]{1, 2, 3, 4}, new int[]{1, 2, 5, 6}));
        System.out.println(longestPath(5, new int[]{0, 0, 2, 2}, new int[]{1, 2, 3, 4}, new int[]{5, 2, 5, 6}));
