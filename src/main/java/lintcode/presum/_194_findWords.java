...
/**
 * Given a string str and a dictionary dict, you need to find out which words in the dictionary are
 * subsequences of the string and return those words.The order of the words returned should be the
 * same as the order in the dictionary.
 *
 * <p>样例 Example 1:
 *
 * <p>Input: str="bcogtadsjofisdhklasdj" dict=["book","code","tag"] Output: ["book"]
 * Explanation:Only book is a subsequence of str
 *
 * <p>Example 2:
 *
 * <p>Input: str="nmownhiterer" dict=["nowhere","monitor","moniter"] Output: ["nowhere","moniter"]
 * 挑战 |str|<=100000
 *
 * <p>注意事项 |str|<=1000 the sum of all words length in dictionary<=1000 (All characters are in
 * lowercase)
 */
  ...
  public static List<String> findWords(String str, List<String> dict) {
    ...
    for (int i = 0; i < str.length(); i++) {
      List<Integer> indexPositions =
          char2IndexPosition.getOrDefault(str.charAt(i), new ArrayList<>());
