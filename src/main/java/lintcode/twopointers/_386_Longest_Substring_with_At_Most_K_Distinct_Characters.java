...
public class _386_Longest_Substring_with_At_Most_K_Distinct_Characters {
  ...
  public static int lengthOfLongestSubstringKDistinct(String s, int k) {
    ...
    for (int end = 0; end < s.length(); end++) {
      //      System.out.println(end + "," +s.charAt(end) + "," + (s.charAt(end) - 'a') + "," +
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "27 == "
            + lengthOfLongestSubstringKDistinct("eqgkcwGFvjjmxutystqdfhuMblWbylgjxsxgnoh", 16));
    System.out.println(
        "21 == "
            + lengthOfLongestSubstringKDistinct(
                "nutdrgzdrkrvfdfcvzuunxwlzegjukhkjpvqruitobiahxhgdrpqttsebjsg", 11));
  }
}
