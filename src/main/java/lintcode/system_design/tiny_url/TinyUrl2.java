...
public class TinyUrl2 {
  ...
  private final HashMap<Integer, String> id2url = new HashMap<Integer, String>();
  private final HashMap<String, Integer> url2id = new HashMap<String, Integer>();

  public static void main(String[] args) {
    TinyUrl2 tinyUrl2 = new TinyUrl2();
    System.out.println(
        tinyUrl2.shortToLong(tinyUrl2.longToShort("http://www.lintcode.com/faq/?id=10")));
  }
