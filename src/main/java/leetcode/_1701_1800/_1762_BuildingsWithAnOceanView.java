...
public class _1762_BuildingsWithAnOceanView {
  ...
  public static void main(String[] args) {
    System.out.println("[0, 1, 2, 3] == " + Arrays.toString(findBuildings(new int[] {4, 3, 2, 1})));
    System.out.println("[0, 2, 3] == " + Arrays.toString(findBuildings(new int[] {4, 2, 3, 1})));
    System.out.println("[3] == " + Arrays.toString(findBuildings(new int[] {1, 3, 2, 4})));
  }
