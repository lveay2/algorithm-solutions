 ...
 * inclusive.
 *
 * <p>Example: Given nums = [-2, 0, 3, -5, 2, -1]
 *
 * <p>sumRange(0, 2) -> 1 sumRange(2, 5) -> -1 sumRange(0, 5) -> -3
 *
 * <p>Note: You may assume that the array does not change. There are many calls to sumRange
 * function.
 *
 * <p>Your NumArray object will be instantiated and called as such: NumArray obj = new
