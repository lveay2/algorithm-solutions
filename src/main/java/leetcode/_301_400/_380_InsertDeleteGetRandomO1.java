...
public class _380_InsertDeleteGetRandomO1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("2 == " + randomizedSet.getRandom()); // getRandom() should return either 1 or 2 randomly.
  ...
  static class RandomizedSet {
    ...
    public boolean remove(int val) {
      ...
      int newIndex = val2Index.get(val);
      if (newIndex < nums.size() - 1) {
        int lastVal = nums.get(nums.size() - 1);
        nums.set(newIndex, lastVal);
        val2Index.put(lastVal, newIndex);
      }
