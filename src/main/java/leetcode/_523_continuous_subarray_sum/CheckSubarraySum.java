 ...
 *
 * <p>Example 2: Input: [23, 2, 6, 4, 7], k=6 Output: True Explanation: Because [23, 2, 6, 4, 7] is
 * an continuous subarray of size 5 and sums up to 42.
 *
 * <p>Note: The length of the array won't exceed 10,000. You may assume the sum of all the numbers
 * is in the range of a signed 32-bit integer.
 */
public class CheckSubarraySum {

  public static void main(String[] args) {
    System.out.println(
        "true == " + new CheckSubarraySum().checkSubarraySum(new int[] {23, 2, 4, 6, 7}, 6));

    System.out.println("true == " + new CheckSubarraySum().checkSubarraySum(new int[] {0, 0}, 0));

    System.out.println(
        "false == " + new CheckSubarraySum().checkSubarraySum(new int[] {0, 1, 0}, 0));
  }
