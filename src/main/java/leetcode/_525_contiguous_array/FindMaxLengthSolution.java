 ...
 *
 * <p>Example 2: Input: [0,1,0] Output: 2 Explanation: [0, 1] (or [1, 0]) is a longest contiguous
 * subarray with equal number of 0 and 1.
 *
 * <p>Note: The length of the given binary array will not exceed 50,000.
 */
public class FindMaxLengthSolution {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        new FindMaxLengthSolution().findMaxLength(new int[] {0, 0, 1, 0, 0, 0, 1, 1}));
  }
