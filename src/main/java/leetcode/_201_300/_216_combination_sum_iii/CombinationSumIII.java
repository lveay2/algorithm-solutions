 ...
 * <p>Note:
 *
 * <p>All numbers will be positive integers. The solution set must not contain duplicate
 * combinations. Example 1:
 *
 * <p>Input: k = 3, n = 7 Output: [[1,2,4]] Example 2:
 *
...
public class CombinationSumIII {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "[[1, 2, 6], [1, 3, 5], [2, 3, 4]] == " + new CombinationSumIII().combinationSum3(3, 9));
  }
