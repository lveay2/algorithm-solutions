...
public class ValidPalindromeII {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("true == " + new ValidPalindromeII().validPalindrome("aguokepatgbnvfqmgmlcupuufxoohdfpgjdmysgvhmvffcnqxjjxqncffvmhvgsymdjgpfdhooxfuupuculmgmqfvnbgtapekouga"));
    }
