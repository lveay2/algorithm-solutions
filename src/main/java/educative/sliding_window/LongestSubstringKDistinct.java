 ...
 * Example 1:
 * <p>
 * Input: String="araaci", K=2 Output: 4 Explanation: The longest substring with no more than '2'
 * distinct characters is "araa." Example 2:
 * <p>
 * Input: String="araaci", K=1 Output: 2 Explanation: The longest substring with no more than '1'
 * distinct characters is "aa." Example 3:
 * <p>
 * Input: String="cbbebi", K=3 Output: 5 Explanation: The longest substrings with no more than '3'
