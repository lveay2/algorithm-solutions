 ...
 * <p>Example 1:
 *
 * <p>Input: String="aabccbb", k=2 Output: 5 Explanation: Replace the two 'c' with 'b' to have a
 * longest repeating substring "bbbbb".
 *
 * <p>Example 2:
 *
 * <p>Input: String="abbcb", k=1 Output: 4 Explanation: Replace the 'c' with 'b' to have a longest
 * repeating substring "bbbb".
 *
 * <p>Example 3:
 *
 * <p>Input: String="abccde", k=1 Output: 3 Explanation: Replace the 'b' or 'd' with 'c' to have the
