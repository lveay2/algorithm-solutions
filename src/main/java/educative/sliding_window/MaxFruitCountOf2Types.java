 ...
 * fruit type.
 *
 * <p>Write a function to return the maximum number of fruits in both the baskets.
 *
 * <p>Example 1:
 *
 * <p>Input: Fruit=['A', 'B', 'C', 'A', 'C'] Output: 3 Explanation: We can put 2 'C' in one basket
 * and one 'A' in the other from the subarray ['C', 'A', 'C']
 *
 * <p>Example 2:
 *
 * <p>Input: Fruit=['A', 'B', 'C', 'B', 'B', 'C'] Output: 5 Explanation: We can put 3 'B' in one
 * basket and two 'C' in the other basket. This can be done if we start with the second letter:
 * ['B', 'C', 'B', 'B', 'C']
 */
