 ...
 * has some numbers appearing twice, find all these duplicate numbers without using any extra space.
 *
 * <p>Example 1:
 *
 * <p>Input: [3, 4, 4, 5, 5] Output: [4, 5]
 *
 * <p>Example 2:
 *
 * <p>Input: [5, 4, 7, 2, 3, 5, 3] Output: [3, 5]
 */
