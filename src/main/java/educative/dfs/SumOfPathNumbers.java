...
public class SumOfPathNumbers {
    ...
    private static int findRootToLeafPathNumbers(TreeNode currentNode, int pathSum) {
        ...
        return findRootToLeafPathNumbers(currentNode.left, pathSum) + findRootToLeafPathNumbers(
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total Sum of Path Numbers: 332 == " + SumOfPathNumbers.findSumOfPathNumbers(root));
    }
