 ...
 * two methods:
 *
 * <p>insertNum(int num): stores the number in the class findMedian(): returns the median of all
 ...
 * <p>Example 1:
 *
 * <p>1. insertNum(3) 2. insertNum(1) 3. findMedian() -> output: 2 4. insertNum(5) 5. findMedian()
