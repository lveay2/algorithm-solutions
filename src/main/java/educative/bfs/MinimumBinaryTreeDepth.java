...
public class MinimumBinaryTreeDepth {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tree Minimum Depth: 2 == " + MinimumBinaryTreeDepth.findDepth(root));
        root.left.left = new TreeNode(9);
        root.right.left.left = new TreeNode(11);
        System.out.println("Tree Minimum Depth: 3 == " + MinimumBinaryTreeDepth.findDepth(root));
    }
