...
public class TasksSchedulingOrder {
    ...
    public static void main(String[] args) {
        List<Integer> result = TasksSchedulingOrder.findOrder(3, new int[][]{new int[]{0, 1}, new int[]{1, 2}});
        ...
        result = TasksSchedulingOrder.findOrder(6, new int[][]{new int[]{2, 5}, new int[]{0, 5}, new int[]{0, 4},
