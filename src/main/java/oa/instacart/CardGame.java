...
/**
 * Given an input of cards that have suits { +, -, = }, values { A, B, C }, and different counts of
 * values [1 - 3]. Find a valid hand. A valid hand consists of 3 cards. Where all the suits are
 * different or the same, all the values are different or the same, and all counts are different or
 * the same.
 *
 * <p>https://leetcode.com/discuss/interview-question/554340/Instacart-or-Onsite-or-Create-Card-Hands
 */
public class CardGame {

  private static final List<Character> prefixes = Arrays.asList('-', '+', '=');
  private static final List<Character> letters = Arrays.asList('A', 'B', 'C');
