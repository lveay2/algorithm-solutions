...
public class ConversationTree {
    ...
    public void printConversation(List<IndentationAndInputObject> flatTree, List<String> userAnswers) {
        ...
        for (int i = 1; i < flatTree.size(); i++) {
            ...
            if (nextIaio.getInputObject() instanceof Output) {
                ...
                nextNode = indent2Node.get(label2OutputObject.get(nextIaio.getInputObject().getLabel().getAsInt()));
                current.nexts.add(nextNode);
            }
            current = nextNode;
        }
    ...
    public static void main(String args[]) throws Exception {
        new ConversationTree().printConversation(Arrays.asList(
...
//            }
    ...
    static class Output implements InputObject {
        ...
        public String toString() {
            return String.format("Output(text='%s', label=%d)", this.text, this.label.isPresent() ? this.label.getAsInt() : 0);
        }
