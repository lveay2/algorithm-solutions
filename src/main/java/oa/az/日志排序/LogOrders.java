...
public class LogOrders {
    ...
    public static void main(String[] args) {
        System.out.println("[a100 Act zoo, g9 act car, zo4 4 7, a1 9 2 3 1] == " + Arrays.toString(new LogOrders().logSort(new String[]{"zo4 4 7", "a100 Act zoo", "a1 9 2 3 1", "g9 act car"})));

        System.out.println("[a100 Act zoo, a100 Actzoo, Tab Bctzoo, Tac Bctzoo, g9 act car, zo4 4 7] == " + Arrays.toString(new LogOrders().logSort(new String[]{"zo4 4 7", "a100 Actzoo", "a100 Act zoo", "Tac Bctzoo", "Tab Bctzoo", "g9 act car"})));

        System.out.println("[a100 Act zoo, a100 Actzoo, Tab Bctzoo, Tac Bctzoo, g9 act car, zo4 43421451435143213 7] == " + Arrays.toString(new LogOrders().logSort(new String[]{"zo4 43421451435143213 7", "a100 Actzoo", "a100 Act zoo", "Tac Bctzoo", "Tab Bctzoo", "g9 act car"})));
    }
    ...
    public String[] logSort(String[] logs) {
        ...
        PriorityQueue<String> queue = new PriorityQueue<>(logs.length, (s1, s2) -> {
