...
public class MinScore {
    ...
    public static int getMinScore(int productsNodes, List<Integer> productsFrom,
                                  List<Integer> productsTo) {
        Map<Integer, Set<Integer>> product2RelatedProducts = crateProductsRelationship(productsFrom,
                productsTo);
    ...
    private static Map<Integer, Set<Integer>> crateProductsRelationship(List<Integer> productsFrom,
                                                                        List<Integer> productsTo) {
    ...
    public static void main(String[] args) {
        System.out
                .println(getMinScore(6, Arrays.asList(1, 2, 2, 3, 4, 5), Arrays.asList(2, 4, 5, 5, 5, 6)));
        System.out
                .println(getMinScore(5, Arrays.asList(1, 1, 2, 2, 3, 4), Arrays.asList(2, 3, 3, 4, 4, 5)));
