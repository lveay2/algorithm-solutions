...
/**
 * Implement a data structure with functionality similar to a hash table. In our custom data structure, Insert & delete operation will return a snapID and we pass on the snapID for lookup.
 *
 * For instance say DS is our custom data structure
 *
 * Operation
 * Result
